...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Expense.doc_num'
        db.alter_column(u'expense', 'doc_num', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'Expense.doc_num'
        db.alter_column(u'expense', 'doc_num', self.gf('django.db.models.fields.IntegerField')(null=True))
