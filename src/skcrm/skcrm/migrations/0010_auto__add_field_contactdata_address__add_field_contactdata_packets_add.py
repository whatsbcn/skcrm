...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactData.address'
        db.add_column(u'contact_data', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ContactData.packets_address'
        db.add_column(u'contact_data', 'packets_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ContactData.postal_code'
        db.add_column(u'contact_data', 'postal_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'ContactData.country'
        db.add_column(u'contact_data', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=73, to=orm['skcrm.Country'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContactData.region'
        db.add_column(u'contact_data', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=33, to=orm['skcrm.Region'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ContactData.city'
        db.add_column(u'contact_data', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=899, to=orm['skcrm.City'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'ContactData.position'
        db.alter_column(u'contact_data', 'position_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skcrm.PositionTypes'], null=True))

        # Changing field 'ContactData.type'
        db.alter_column(u'contact_data', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['skcrm.ContactDataType']))

    def backwards(self, orm):
        # Deleting field 'ContactData.address'
        db.delete_column(u'contact_data', 'address')

        # Deleting field 'ContactData.packets_address'
        db.delete_column(u'contact_data', 'packets_address')

        # Deleting field 'ContactData.postal_code'
        db.delete_column(u'contact_data', 'postal_code')

        # Deleting field 'ContactData.country'
        db.delete_column(u'contact_data', 'country_id')

        # Deleting field 'ContactData.region'
        db.delete_column(u'contact_data', 'region_id')

        # Deleting field 'ContactData.city'
        db.delete_column(u'contact_data', 'city_id')


        # User chose to not deal with backwards NULL issues for 'ContactData.position'
        raise RuntimeError("Cannot reverse this migration. 'ContactData.position' and its values cannot be restored.")

        # Changing field 'ContactData.type'
        db.alter_column(u'contact_data', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skcrm.ContactDataType'], null=True))
    ...
    models = {
        ...
        'skcrm.company': {
            ...
            'contact_ptr_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
