...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExpenseItem.concept_sub_type'
        db.alter_column(u'expense_item', 'concept_sub_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skcrm.ExpenseConceptSubType'], null=True))

    def backwards(self, orm):

        # Changing field 'ExpenseItem.concept_sub_type'
        db.alter_column(u'expense_item', 'concept_sub_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['skcrm.ExpenseConceptSubType']))
