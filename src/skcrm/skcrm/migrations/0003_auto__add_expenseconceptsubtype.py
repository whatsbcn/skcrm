...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExpenseConceptSubType'
        db.create_table(u'expense_concept_subtypes', (
        ...
        db.send_create_signal('skcrm', ['ExpenseConceptSubType'])


    def backwards(self, orm):
        # Deleting model 'ExpenseConceptSubType'
        db.delete_table(u'expense_concept_subtypes')
