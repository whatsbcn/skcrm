...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContactData.description'
        db.add_column(u'contact_data', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContactData.description'
        db.delete_column(u'contact_data', 'description')
