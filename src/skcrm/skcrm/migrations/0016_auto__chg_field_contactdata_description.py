...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactData.description'
        db.alter_column(u'contact_data', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ContactData.description'
        raise RuntimeError("Cannot reverse this migration. 'ContactData.description' and its values cannot be restored.")
