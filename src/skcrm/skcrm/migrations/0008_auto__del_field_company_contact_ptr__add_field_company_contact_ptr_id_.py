...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.id'
        db.add_column(u'company', 'id',
                      self.gf('django.db.models.fields.IntegerField')(),
                      #self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)

        # Adding field 'Company.name'
        db.add_column(u'company', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Company.email'
        db.add_column(u'company', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=45, blank=True),
                      keep_default=False)

        # Adding field 'Company.website'
        db.add_column(u'company', 'website',
        ...
        # Adding field 'Company.disabled'
        db.add_column(u'company', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Company.NIF_CIF'
        db.add_column(u'company', 'NIF_CIF',
...
#
#        # Adding M2M table for field type on 'Company'
...
#        db.create_unique('rel_company_types', ['company_id', 'companytype_id'])
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Company.contact_ptr'
        raise RuntimeError("Cannot reverse this migration. 'Company.contact_ptr' and its values cannot be restored.")
        # Deleting field 'Company.contact_ptr_id'
        db.delete_column(u'company', 'contact_ptr_id')

        # Deleting field 'Company.id'
        db.delete_column(u'company', 'id')

        # Deleting field 'Company.name'
        db.delete_column(u'company', 'name')

        # Deleting field 'Company.email'
        db.delete_column(u'company', 'email')

        # Deleting field 'Company.website'
        db.delete_column(u'company', 'website')

        # Deleting field 'Company.mailing'
        db.delete_column(u'company', 'mailing')

        # Deleting field 'Company.disabled'
        db.delete_column(u'company', 'disabled')

        # Deleting field 'Company.NIF_CIF'
        db.delete_column(u'company', 'NIF_CIF')
        ...
        # Removing M2M table for field type on 'Company'
        db.delete_table('rel_company_types')
