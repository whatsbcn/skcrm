...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ContactData.company'
        db.alter_column(u'contact_data', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skcrm.Company'], null=True))

        # Changing field 'ContactData.person'
        db.alter_column(u'contact_data', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skcrm.Person'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ContactData.company'
        raise RuntimeError("Cannot reverse this migration. 'ContactData.company' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ContactData.person'
        raise RuntimeError("Cannot reverse this migration. 'ContactData.person' and its values cannot be restored.")
