...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.info_text'
        db.add_column(u'person', 'info_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Person.warning_text'
        db.add_column(u'person', 'warning_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.info_text'
        db.delete_column(u'person', 'info_text')

        # Deleting field 'Person.warning_text'
        db.delete_column(u'person', 'warning_text')
    ...
    models = {
        ...
        'skcrm.person': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'info_text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'warning_text': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '100', 'blank': 'True'})
        },
        'skcrm.persontype': {
        ...
        'skcrm.section': {
            'Meta': {'ordering': "['parent__parent__name', 'parent__name', 'name']", 'object_name': 'Section', 'db_table': "u'section'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'skcrm.sector': {
            'Meta': {'ordering': "['parent__parent__name', 'parent__name', 'name']", 'object_name': 'Sector', 'db_table': "u'sectors'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '45'}),
