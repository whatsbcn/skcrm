...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ContactData.telf_static'
        db.add_column(u'contact_data', 'telf_static',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ContactData.telf_movile'
        db.add_column(u'contact_data', 'telf_movile',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ContactData.fax'
        db.add_column(u'contact_data', 'fax',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ContactData.email'
        db.add_column(u'contact_data', 'email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ContactData.email_alt'
        db.add_column(u'contact_data', 'email_alt',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'contact_phones', (
            ...
            ('contact_data', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skcrm.ContactData'], null=True, blank=True)),
        ))
        ...
        # Deleting field 'ContactData.telf_static'
        db.delete_column(u'contact_data', 'telf_static')

        # Deleting field 'ContactData.telf_movile'
        db.delete_column(u'contact_data', 'telf_movile')

        # Deleting field 'ContactData.fax'
        db.delete_column(u'contact_data', 'fax')

        # Deleting field 'ContactData.email'
        db.delete_column(u'contact_data', 'email')

        # Deleting field 'ContactData.email_alt'
        db.delete_column(u'contact_data', 'email_alt')
    ...
    models = {
        ...
        'skcrm.contactdata': {
            ...
            'email_alt': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'postal_code': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'region': ('django.db.models.fields.related.ForeignKey', [], {'default': '33', 'to': "orm['skcrm.Region']", 'null': 'True', 'blank': 'True'}),
            'telf_movile': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'telf_static': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
