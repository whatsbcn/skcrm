...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Person.has_personal_assistant'
        db.delete_column(u'person', 'has_personal_assistant_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Person.has_personal_assistant'
        db.add_column(u'person', 'has_personal_assistant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['skcrm.Person'], null=True, blank=True),
                      keep_default=False)
