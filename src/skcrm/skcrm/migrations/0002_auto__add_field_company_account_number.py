...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.account_number'
        db.add_column(u'company', 'account_number',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Company.account_number'
        db.delete_column(u'company', 'account_number')
