    ...
    if report == "gastos_por_ot":
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                concept_sub_type = form.cleaned_data['concept_sub_type']
                ...
                if concept_type:
                    selected_expense_items = selected_expense_items.filter(concept_type=concept_type)
                    header_data += [('Concepto:', str(concept_type))]                    
                if concept_sub_type:
                    selected_expense_items = selected_expense_items.filter(concept_sub_type=concept_sub_type)
                    header_data += [('Subconcepto:', str(concept_sub_type))]
